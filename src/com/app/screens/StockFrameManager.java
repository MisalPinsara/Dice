...
public class StockFrameManager extends javax.swing.JFrame {

        private final InventoryController inventoryController = new InventoryController();

        public StockFrameManager() {
                initComponents();
                loadFilterData();
                refreshTable();
        ...
        private void refreshTable() {
                new Thread(() -> {
                        List<ShoeItem> shoes = inventoryController.getAllShoes();
                        java.awt.EventQueue.invokeLater(() -> {
                                DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                                model.setRowCount(0);
                                for (ShoeItem item : shoes) {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Set Threshold");
        jButton2.addActionListener(this::jButton2ActionPerformed);

        jButton4.setText("Manage Suppliers");
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
                ...
                new UpdateStockFrame(id).setVisible(true);
        }// GEN-LAST:event_jButton1ActionPerformed

        private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
                new CommonFormFrame("thresholds").setVisible(true);
