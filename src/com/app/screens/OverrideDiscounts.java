...
public class OverrideDiscounts extends javax.swing.JFrame {

    private final InventoryController inventoryController = new InventoryController();

    public OverrideDiscounts() {
        initComponents();
        jButton1.addActionListener(e -> applyOverride());
    ...
    private void applyOverride() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Discount override of " + discount + "% applied.");
            this.dispose();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Discount Override (%) :");
